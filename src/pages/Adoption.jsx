...
const Adoption = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_1a30tig', 'template_fp7989f', form.current, '3l4D56Hv6nafOi3BZ')
            .then((result) => {
    ...
    return (
        <div>
            ...
            <div className="MainAdoptionHeading">
                <h1>Re-Home and Adopt a Pet Today</h1>
                ...
                <div className="journeycontent">
                    ...
                    <div className="journeyleft">
                        ...
                        <div className="adoptionpoints">
                            ...
                            <div className="pointscontent">
                                <span>Connect And Adopt love</span>
                                <p>Once you find a pet, fill out the form to contact the pet owner and get in touch with them. Let them know why you will be a suitable friend for their furry little one.</p>
                            </div>
                        </div>
                        <div className="adoptionpoints">
                            ...
                            <div className="pointscontent">
                                ...
                                <p>Fill in the details of the pet. Give your own pet a second home or provide a safe shelter to our rescued warriors.</p>
                            </div>
                        </div>
                        <div className="adoptionpoints">
